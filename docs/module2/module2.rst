...
*GitOps* is the practice of managing infrastructure and configurations using Git. Git becomes the single source of truth; meaning it contains the entire state of systems and provides 
